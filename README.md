...
- I have completed a bachelor's degree in Kent, and I'll study postgraduate.
...
- My favourite series of microcontrollers are RP2040, RP2350, stm32F4, stm32L4, stm32F0, atmega328P.
...
- I have evaluation development tools: Arduino UNO R3/4, Arduino Mega, NUCLEO-F030R8, NUCLEO-F439ZI, Raspberry Pi 1/4/5 Model B, Atmega328p xplained mini, Raspberry Pi Pico (first and second version), and own RP2040 MCU development board (later will fully release).
